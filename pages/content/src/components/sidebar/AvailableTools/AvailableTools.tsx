...
const AvailableTools: React.FC<AvailableToolsProps> = ({ tools, onExecute, onRefresh, isRefreshing }) => {
  ...
  return (
    <Card className="border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
      ...
      {isExpanded && (
        <CardContent className="p-4 pt-0 bg-white dark:bg-slate-900">
          <div className="mb-4">
                  ...
                  {expandedTools.has(tool.name) && (
                    <div className="p-3 border-t border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900">
                      ...
                      <div className="mt-2">
                        ...
                        <pre className="text-xs bg-slate-50 dark:bg-slate-800 p-2 rounded overflow-x-auto text-slate-700 dark:text-slate-300">
                          {tool.schema}
                        </pre>
                      </div>
                    </div>
