...
export async function initializeEventSystem(): Promise<void> {
  ...
  console.info('[EventSystem] Event system initialized successfully.');
}
...
export function cleanupEventSystem(): void {
  console.info('[EventSystem] Cleaning up event system...');
  ...
  console.info('[EventSystem] Event system cleaned up.');
}
